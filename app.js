      ...
      <div class="welcome-footer">
        <div class="footer-col steps">
          ...
          <ol>
            ...
            <li>הורידו את נתוני הבחינות ממערכת ה-<strong>iTest</strong> (המערכת הישנה), שמרו וחלצו אותם בכל תיקייה שתבחרו על המחשב שלכם (התיקייה צריכה להכיל בתוכה את תעודות הזהות של התלמידים).</li>
