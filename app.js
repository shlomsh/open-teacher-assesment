      ...
      <div class="welcome-footer">
        <div class="footer-col steps">
          ...
          <ol>
            ...
            <li>היכנסו למערכת ה-<strong>iTest</strong> (המערכת הישנה) והורידו את קובץ נתוני הבחינות (לרוב ירד כקובץ מכווץ - Zip).</li>
            <li>שמרו את הקובץ בכל תיקייה שתבחרו על המחשב שלכם.</li>
            <li>חלצו את הקובץ (Extract All) לתיקייה רגילה, וודאו שהיא מכילה בתוכה את תעודות הזהות של התלמידים.</li>
            <li>לחצו על הכפתור למעלה ובחרו את התיקייה הראשית שזה עתה חלצתם.</li>
          </ol>
        </div>
